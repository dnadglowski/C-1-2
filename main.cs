...
class Program {
  public static void Main (string[] args) {
    ...
    Console.WriteLine ("No, I can't help but to hear an exchanging of words..." + Environment.NewLine);
    Console.WriteLine ("Oh-oh-oh-oh-oh,");
    Console.WriteLine ("oh-oh-oh-oh,");
    Console.WriteLine ("oh-oh-oh /");
    Console.WriteLine ("Caught in a bad romance..." + Environment.NewLine);
    ...
    Console.WriteLine ("Because I want it all" + Environment.NewLine);
